...
/*
 * The reconciled current validator has 65 prior component validators plus
 * the two new owner-evidence static/behavior certifications.
 */
...
assert.equal(
  ...
  67,
  'current component validator inventory must contain exactly 67 validators'
);
...
console.log('COMPONENT_VALIDATOR_COUNT=67');
